...
class AgentServicer(object):
    ...
    def LoadModel(self, request, context):
        ...
        8. INVALID_ARGUMENT - model alias invalid
    ...
    def DescribeModel(self, request, context):
        ...
        describes a model
        Status Codes:
        1. OK - describe model is successful
        2. UNKNOWN - unknown error has occurred
        3. INTERNAL - an internal error has occurred
        4. NOT_FOUND - model doesn't exist at the url
        5. INVALID_ARGUMENT - tensor index out of boundary or tensor shape dimensions mismatch
    ...
    def CaptureData(self, request, context):
        ...
        10. NOT_FOUND - model alias is not registered
    ...
    def GetCaptureDataStatus(self, request, context):
        ...
        Status Codes:
        1. OK - get data capture status successfully
        2. UNKNOWN - unknown error has occurred
        3. INTERNAL - an internal error has occurred
